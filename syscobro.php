  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">SysCobro</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="inicio.php">Inicio</a></li>
              <li class="breadcrumb-item active">SysCobro</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <!-- /.content-header -->
    <form method="POST" id="frmSysCobro" name="frmSysCobro">
    <!-- Main content -->
    <div class="content">
      <div class="container-fluid">
        <!-- aqui va la tabla -->
      
        <?php require_once 'Views/form/frmSyscobro.php';  ?>
      </div><!-- /.container-fluid -->
    </div>
    <!-- /.content -->
   </form>
...
<script src="Controller/syscobro.js"></script>
<script>
